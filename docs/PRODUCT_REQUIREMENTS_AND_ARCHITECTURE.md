...
> 2026-08-05 覆盖说明：当前实现以 SQLite v11 和 [今日热点迭代记录](ITERATION_2026-08-05_DAILY_TOPICS.md) 为准。今日热点替代每日简报入口：它只归并配置时区当天尚未归属的可见事件，成功关系只追加、不重排，累计至少 2 条真实内容后按内容条数统计热度。本文中所有“本周热点可全量重算、展示名随本周更新、v10 为目标结构”的描述均视为历史设计。
